...
import 'package:utsmobile_karinaqurani/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.43.110/uts_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.43.110/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
